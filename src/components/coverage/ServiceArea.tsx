  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        {/* Unified Interactive Postcode Checker & Metro Dispatch Radar Card */}
        <ScrollReveal delay={0.08} className="w-full">
          <div className="bg-white rounded-none border border-slate-200/90 shadow-md p-4 sm:p-6 lg:p-8 relative overflow-hidden flex flex-col">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-4 sm:pb-6 mb-6 border-b border-slate-100">
              <div className="flex items-center gap-3">
                <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-none bg-blue-50 border border-blue-200 text-blue-700 flex items-center justify-center flex-shrink-0 shadow-xs">
                ...
                <div>
                  <div className="flex items-center gap-2.5 flex-wrap">
                    <h3 className="text-lg sm:text-xl font-extrabold text-navy-900">
                      Live Emergency Response &amp; Dispatch Radar
                    </h3>
                    <div className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-none bg-emerald-50 border border-emerald-200 text-emerald-800 text-[11px] font-bold">
                      <div className="w-2 h-2 rounded-none bg-emerald-500 animate-pulse" />
                      <span>Live Metro Coverage</span>
                    </div>
                  </div>
                  <p className="text-xs sm:text-sm text-slate-600 font-normal mt-0.5">
                    Check your London address or postcode for instant coverage, arrival times, and nearest engineer units.
                  </p>
                </div>
              </div>
            ...
            {/* Split Content: Controls on Left, Live Radar Map on Right */}
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
              {/* Left Column: Postcode Search, Results, Quick Select, and 4 Zoned Hubs */}
              <div className="lg:col-span-5 xl:col-span-5 flex flex-col space-y-5">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2.5">
                    <div className="relative flex-1">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-9 py-3 rounded-none border-2 border-slate-200 focus:border-blue-600 focus:ring-2 focus:ring-blue-500/20 text-navy-900 placeholder:text-slate-400 font-medium text-sm sm:text-base transition-all outline-none"
                    ...
                    <button
                      type="submit"
                      className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-sm bg-blue-700 hover:bg-blue-800 active:bg-blue-900 text-white font-extrabold text-sm shadow-xs hover:shadow transition-all duration-150 flex-shrink-0"
                    >
                      <Search className="w-4 h-4" aria-hidden="true" />
                ...
                {checkStatus === 'covered' && (
                  <div
                    className="rounded-none bg-emerald-50 border-2 border-emerald-400/80 p-4 text-emerald-950 transition-all duration-200 animate-fadeIn"
                    role="status"
                    aria-live="polite"
                  >
                    <div className="flex items-start gap-3">
                      <div className="w-8 h-8 rounded-none bg-emerald-600 text-white flex items-center justify-center flex-shrink-0 shadow-xs mt-0.5">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-3 flex-wrap">
                          <a
                            ...
                            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-sm bg-emerald-700 hover:bg-emerald-800 text-white font-bold text-xs shadow-xs transition-colors"
                          ...
                          <a
                            ...
                            className="inline-flex items-center justify-center p-2 rounded-sm bg-white hover:bg-emerald-100 text-emerald-800 border border-emerald-300 transition-colors shadow-2xs"
                ...
                {checkStatus === 'out-of-area' && (
                  <div
                    className="rounded-none bg-amber-50 border-2 border-amber-300 p-4 text-amber-950 transition-all duration-200 animate-fadeIn"
                    role="alert"
                  >
                    <div className="flex items-start gap-3">
                      <div className="w-8 h-8 rounded-none bg-amber-500 text-white flex items-center justify-center flex-shrink-0 shadow-xs mt-0.5">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <a
                          href={`tel:${SITE_CONFIG.business.phone}`}
                          className="mt-3 inline-flex items-center gap-2 px-4 py-2 rounded-sm bg-amber-500 hover:bg-amber-600 active:bg-amber-700 text-navy-950 font-bold text-xs shadow-xs transition-all"
                ...
                {checkStatus === 'invalid' && (
                  <div className="rounded-none bg-red-50 border-2 border-red-200 p-3.5 text-red-800 flex items-center gap-2.5">
                    ...
                    {POPULAR_ZIPS.map((item, idx) => {
                      ...
                      return (
                        <button
                          ...
                          className={`inline-flex items-center gap-1 px-2.5 py-1.5 rounded-none text-xs font-semibold transition-all ${
                ...
                {/* 4 Zoned Dispatch Hubs (2x2 Grid) */}
                <div className="pt-3 border-t border-slate-100">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs font-bold uppercase tracking-wider text-slate-600">
                      4 Zoned Mobile Dispatch Fleets:
                    </span>
                    <span className="text-[11px] text-slate-500 font-medium">
                      Click hub to focus radar
                    </span>
                  </div>
                    ...
                    {DISPATCH_HUBS.map((hub) => {
                      ...
                      return (
                        <button
                          ...
                          className={`p-2.5 sm:p-3 rounded-none border text-left transition-all duration-150 cursor-pointer group ${
                            isActive
                        ...
                        >
                          <div className="flex items-center justify-between gap-1 mb-1">
                            <span
                              className={`text-[10px] font-mono font-extrabold uppercase px-1.5 py-0.5 rounded-none border w-fit transition-colors ${
                                isActive
                            ...
                            <span className="text-[10px] font-bold text-emerald-700 bg-emerald-50 px-1.5 py-0.5 rounded-none border border-emerald-200 w-fit">
                              ETA: {hub.eta}
                            </span>
                          </div>
                          <h4 className="text-xs font-extrabold text-navy-900 leading-snug group-hover:text-orange-600 transition-colors line-clamp-1">
                            {hub.name}
                          </h4>
                          <p className="text-[11px] text-slate-600 mt-0.5 font-normal leading-tight line-clamp-1">
                            {hub.area}
                          </p>
                        </button>
                      );
              ...
              <div className="lg:col-span-7 xl:col-span-7 flex flex-col h-full">
                ...
                <div className="relative w-full h-[360px] sm:h-[440px] lg:h-[490px] xl:h-[510px] rounded-none overflow-hidden border border-slate-200/90 shadow-inner bg-slate-100">
                  <iframe
                    src={mapUrl}
                  ...
                  {isLocationFocused ? (
                    ...
                    <div className="absolute top-3 left-3 bg-navy-900/90 backdrop-blur-xs text-white px-3.5 py-2 rounded-none shadow-lg border border-navy-700/80 text-xs flex items-center gap-2 pointer-events-none z-10">
                      ...
                      <div>
                        <span className="font-bold block leading-tight">4 Zoned Mobile Fleets Active</span>
                        <span className="text-[11px] text-slate-300">Click any hub on the left to focus live radar</span>
                      </div>
                    </div>
                  )}
                </div>
            ...
            {/* Integrated Bottom Fast Trust & Immediate Dispatch Strip */}
            <div className="mt-6 pt-5 border-t border-slate-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 text-xs text-slate-700">
                <div className="flex items-center gap-2">
                  <ShieldCheck className="w-4 h-4 text-emerald-600 shrink-0" />
                  <span className="font-bold text-navy-900">Zero Travel Surcharge in Primary Zones</span>
                </div>
                <div className="flex items-center gap-2">
                  <Clock className="w-4 h-4 text-amber-500 shrink-0" />
                  <span className="font-bold text-navy-900">Automated Real-Time Nearest-Van Routing</span>
                </div>
              </div>

              <div className="flex items-center gap-3 w-full sm:w-auto shrink-0">
                <span className="text-xs text-slate-500 hidden md:inline">Need urgent dispatch?</span>
                <a
                  href={`tel:${SITE_CONFIG.business.phone}`}
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-sm bg-navy-900 hover:bg-navy-800 text-white text-xs font-bold transition-colors shadow-xs"
