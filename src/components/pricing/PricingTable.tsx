...
const PACKAGE_PERKS: Record<number, string[]> = {
  ...
  1: [
    'Up to 25m motorized main line snaking',
  ...
  3: [
    ...
    'Manufacturer warranty + 1-Year Apex Plumbing labour',
  ],
};
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <ScrollReveal className="text-center max-w-3xl mx-auto mb-8 sm:mb-14">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-navy-900 tracking-tight leading-tight mb-3 sm:mb-4">
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 lg:gap-8 xl:gap-10 relative z-10">
            <div className="w-full max-w-lg lg:max-w-xl xl:max-w-2xl min-w-0">
              <h3 className="text-xl sm:text-2xl md:text-3xl font-black text-white tracking-tight leading-snug mb-2.5">
                Diagnostic Fee: £0
                <span className="block text-orange-400 font-bold md:font-black text-sm sm:text-base md:text-lg lg:text-xl mt-1 sm:mt-1.5">
                  (100% Waived with Any Approved Repair)
                </span>
              </h3>
              <p className="text-xs sm:text-sm md:text-base text-slate-300 leading-relaxed font-normal mb-4 sm:mb-5 max-w-md sm:max-w-lg">
            ...
            <div className="mt-6 lg:mt-0 flex flex-col sm:flex-row lg:flex-col items-center justify-center gap-3 sm:gap-4 w-full sm:w-auto lg:w-auto shrink-0 lg:min-w-[250px] xl:min-w-[260px] mx-auto lg:mx-0">
              <a
                href="#wizard"
