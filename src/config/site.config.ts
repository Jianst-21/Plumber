  ...
  beforeAfter: [
    {
      ...
      title: 'Broken Pull-Out Faucet to Modern High-Arc Fixture',
      problem: 'Cracked internal cartridge and damaged pull-out spray head leaking water over the kitchen counter basin.',
      solution: 'Installed commercial-grade high-arc brushed nickel pull-down faucet with ceramic disc valve and watertight braided supply lines.',
    ...
    {
      id: 'ba-sink-ptrap',
      title: 'Leaking Under-Sink P-Trap to Clean Sealed PVC Assembly',
      problem: 'Severely leaking P-trap joint and deteriorating slip-gaskets causing standing wastewater pooling inside the cabinet.',
      solution: 'Rebuilt complete dual-sink PVC drainage assembly with watertight mechanical slip-joints, clean trap, and dedicated shutoff lines.',
    ...
    },
    {
      ...
      title: 'Toilet Rough-In Flange to Flawless Commode Install',
      problem: 'Cracked leaking commode removed, exposing unsealed floor flange and requiring wax ring replacement, leveling, and water hookup.',
      solution: 'Installed reinforced anti-leak wax ring seal, secured brass closet bolts, leveled dual-flush commode, and connected braided water line.',
